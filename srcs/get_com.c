...
/*   Updated: 2018/01/08 17:16:07 by gdannay          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(ft_strcmp(com, "sa")))
		return (swap(a_pile, NULL));
	else if (!(ft_strcmp(com, "sb")))
		return (swap(b_pile, NULL));
	else if (!(ft_strcmp(com, "ss")))
	{
		...
		return (push(b_pile, a_pile, NULL));
	else if (!(ft_strcmp(com, "pb")))
		return (push(a_pile, b_pile, NULL));
	else if (!(ft_strcmp(com, "ra")))
		return (rotate(a_pile, NULL));
	else if (!(ft_strcmp(com, "rb")))
		return (rotate(b_pile, NULL));
	else if (!(ft_strcmp(com, "rr")))
	{
		...
		return (rev_rotate(a_pile, NULL));
	else if (!(ft_strcmp(com, "rrb")))
		return (rev_rotate(b_pile, NULL));
	else if (!(ft_strcmp(com, "rrr")))
	{
		rev_rotate(a_pile, NULL);
		return (rev_rotate(b_pile, NULL));
	}
	else
		return (1);
